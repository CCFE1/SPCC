...
import { returnLoan, defaultResponse } from "@api/controllers";
import { DBCollectionsResponse } from "@models/interfaces";
import { getDBCollections } from "@api/utils";
import { Collection } from "mongodb";

const returnLoanHandler = async (req: NextApiRequest, res: NextApiResponse) => {
...
export default returnLoanHandler;
